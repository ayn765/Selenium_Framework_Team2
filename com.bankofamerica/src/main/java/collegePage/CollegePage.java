...
public class CollegePage extends BaseAPI {
    ...
    @FindBy(css = WEB_ELEMENT_ESTIMATED_CHILD_COST_OF_COLLEGE)
    public List<WebElement> estimatedChildCost;
    ...
    public int numOfIframes() {
        ...
        // the code for finding the index of the element
